...
export class CheckoutPaymentComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    this.stripe = Stripe(
      'pk_test_51HLoD9GU2f6fwCuWFWwMLgL0dOD8UpJ1ZfPh5Mj8fDqdFIIqqJdBtZ1CpH46BkQ9lIgBZQ0sPmU9AzMkCk2qDwyh00fwyNp5Sl'
    );
  ...
  async submitOrder() {
    ...
    try {
      ...
      if (paymentResult.paymentIntent) {
        ...
        this.taostr.error(paymentResult.error.message);
      }
